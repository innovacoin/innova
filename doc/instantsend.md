...
This mechanism has been integrated into Bitcore-Node-Innova which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/innovacoin/insight-api-innova#web-socket-api](https://github.com/innovacoin/insight-api-innova#web-socket-api) 
* API: [https://github.com/innovacoin/insight-api-innova#instantsend-transactions](https://github.com/innovacoin/insight-api-innova#instantsend-transactions) 
...
By default, the Innova Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Innova Core daemon:
