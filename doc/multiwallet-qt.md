...
Only requiring some minor changes is innova.cpp.
...
Changes to innova.cpp
----------------------
innova.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
