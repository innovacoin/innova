    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Innova Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Innova Core"));
...
All the Innova in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 INNOVA, 0.1 INNOVA, 1 INNOVA and 10 INNOVA -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://innovacoin.atlassian.net/wiki/display/DOC/PrivateSend\">https://innovacoin.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Innova Core is shutting down...") + "<br /><br />" +
