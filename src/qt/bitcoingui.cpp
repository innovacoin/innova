    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Innova Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Innova address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and innova: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Innova Core"), this);
    aboutAction->setStatusTip(tr("Show information about Innova Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Innova Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Innova addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Innova addresses"));
    ...
    openAction->setStatusTip(tr("Open a innova: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Innova Core help message to get a list with possible Innova Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Innova Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("Innova Core"); // default title
