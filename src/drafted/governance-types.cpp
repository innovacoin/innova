...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "InnovaNetwork") type = InnovaNetwork;
    if(strType == "InnovaNetworkVariable") type = InnovaNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == InnovaNetwork) s = "InnovaNetwork";
    if(type == InnovaNetworkVariable) s = "InnovaNetworkVariable";
