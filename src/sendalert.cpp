...
2. run innovad with -printalert or -sendalert like this:
   /path/to/innovad -printalert
...
void ThreadSendAlert()
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.innovacoin.info";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/Innova Core:0.12.0.58/"));
